...
# Usage: ./experiment-semantic.sh <quarkus-version> <chunk-size> <chunk-overlap>
# Example: ./experiment-semantic.sh 3.30.6 1000 300
...
CHUNK_SIZE="$2"
CHUNK_OVERLAP="$3"
EXPERIMENT_NAME="semantic-chunking"
...
echo "========================================"
echo "EXPERIMENT: Semantic Chunking (AsciiDoc headers)"
echo "========================================"
echo "Using JAR:       $JAR"
echo "Repo root:       $REPO"
...
echo "Step 3/3: Baking image with semantic chunking..."
echo ""
